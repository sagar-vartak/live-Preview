...
export default class Stack {
    constructor(...stack_arguments) {
        ...
        if(stack_arguments[0].management_token) {
            this.config['management_token'] = stack_arguments[0].management_token;
        }
 ...
 /**
   ...
   /**
    ...
    livePreview(config) {
        const { enable, include_edit_tags, edit_tags_type, clientUrlParams } = config;
        ...
        if (clientUrlParams) {
            this.config.live_preview['clientUrlParams'] = clientUrlParams
        }

        return (req, res, next) => {
            if(req.query) {
                this.config.live_preview['hash'] = req.query.live_preview;
                this.config.live_preview['content_type_uid'] = req.query.content_type_uid;
                this.config.live_preview['include_edit_tags'] = config.include_edit_tags;
                this.config.live_preview['edit_tags_type'] = config.edit_tags_type;
            }   
            next();
        }
    }
